  ...
  <div class="row">
    ...
    <div class="col-md-12">
      <div class="card shadow-sm mb-4">
        <img src="/public/web_design/design_1.png" class="card-img-top" alt="Project 1">
        <div class="card-body">
    ...
    <div class="col-md-12">
      <div class="card shadow-sm mb-4">
        <img src="/public/web_design/design_2.png" class="card-img-top" alt="Project 2">
        <div class="card-body">
          <h5 class="card-title">Banner</h5>
    ...
    <div class="col-md-12">
      <div class="card shadow-sm mb-4">
        <img src="/public/web_design/design_3.png" class="card-img-top" alt="Project 3">
        <div class="card-body">
          <h5 class="card-title">Banner</h5>
