  ...
  <div class="row">
    ...
    <div class="col-md-12">
      <div class="card shadow-sm mb-4">
        <img src="/public/portfolio/photography_1.jpg" class="card-img-top" alt="Project 1">
        <div class="card-body">
    ...
    <div class="col-md-12">
      <div class="card shadow-sm mb-4">
        <img src="/public/portfolio/photography_2.png" class="card-img-top" alt="Project 2">
        <div class="card-body">
    ...
    <div class="col-md-12">
      <div class="card shadow-sm mb-4">
        <img src="/public/portfolio/photography_3.jpg" class="card-img-top" alt="Project 3">
        <div class="card-body">
