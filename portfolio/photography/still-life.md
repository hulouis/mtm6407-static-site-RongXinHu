  ...
  <div class="row">
    ...
    <div class="col-md-12">
      <div class="card shadow-sm mb-4">
        <img src="/public/portfolio/photography_4.jpg" class="card-img-top" alt="Project 4">
        <div class="card-body">
    ...
    <div class="col-md-12">
      <div class="card shadow-sm mb-4">
        <img src="/public/portfolio/photography_5.jpg" class="card-img-top" alt="Project 5">
        <div class="card-body">
    ...
    <div class="col-md-12">
      <div class="card shadow-sm mb-4">
        <img src="/public/portfolio/photography_6.jpg" class="card-img-top" alt="Project 6">
        <div class="card-body">
